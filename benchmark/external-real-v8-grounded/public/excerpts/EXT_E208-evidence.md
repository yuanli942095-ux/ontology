...
- about its climate-related risks and opportunities. Climate‑related risks are associated with both
- physical risks (such as those resulting from IFRS S2 requires a company to disclose information increased severity of extreme weather) and transition
- about its governance, strategy and risk risks (such as those associated with policy action and management, as well as metrics and targets, in
...
- how a company is required to determine the management process. sustainability‑related risk and opportunity.
